...
export default async function PengeluaranPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="page-header"><div><h1 className="page-title">Pengeluaran Lain</h1><p className="text-sm text-slate-500">Ongkir, listrik, gas, kemasan, dan biaya lainnya.</p></div><a href="/pengeluaran/tambah" className="btn-primary w-full sm:w-auto">+ Tambah Pengeluaran</a></div>
