...
export default async function ModalPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="mb-6 flex items-center justify-between"><div><h1 className="text-3xl font-extrabold">Modal / Belanja</h1><p className="text-sm text-slate-500">Catat pembelian bahan, kemasan, dan kebutuhan produksi.</p></div><a href="/modal/tambah" className="btn-primary">+ Tambah Belanja</a></div>
